...
<div>
  <div data-dialog-backdrop="sign-in-modal" data-dialog-backdrop-close="true" className="inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 backdrop-blur-sm transition-opacity duration-300">
    <div data-dialog="sign-in-modal" className="relative mx-auto w-full max-w-[24rem] rounded-lg overflow-hidden shadow-sm">
  ...
  <div className="px-6">
    ...
    <pre className="bg-gray-800 text-white p-4 rounded-lg overflow-x-scroll"><code>https://unpkg.com/@material-tailwind/html@latest/scripts/dialog.js</code>{"\n"}</pre>
  </div>
</div>
